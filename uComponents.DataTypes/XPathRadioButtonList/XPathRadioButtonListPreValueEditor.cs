...
{
    class XPathRadioButtonListPreValueEditor : AbstractJsonPrevalueEditor
    {
        /// <summary>
        ...
        internal XPathRadioButtonListOptions Options
        {
            get
            {
                if (this.options == null)
                {
                    ...
                    this.options = this.GetPreValueOptions<XPathRadioButtonListOptions>();
                    ...
                    if (this.options == null)
                    {
                        ...
                        this.options = new XPathRadioButtonListOptions();
                    }
                }
                return this.options;
            }
