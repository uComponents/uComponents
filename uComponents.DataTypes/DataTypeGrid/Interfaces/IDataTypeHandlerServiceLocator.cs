...
namespace uComponents.DataTypes.DataTypeGrid.Interfaces
{
    ...
    /// <summary>
    /// Interface for the <see cref="DataTypeHandlerServiceLocator"/>
    /// </summary>
    internal interface IDataTypeHandlerServiceLocator
    {
        /// <summary>
        ...
        TBackingObjectType GetPropertyValue<TBackingObjectType>(IDataType dataType);
        ...
        /// <returns>The backing object.</returns>
        /// <remarks>Called when the method <see cref="GridCell.GetPropertyValue()" /> method is called on a <see cref="GridCell" />.</remarks>
        object GetPropertyValue(IDataType dataType);
