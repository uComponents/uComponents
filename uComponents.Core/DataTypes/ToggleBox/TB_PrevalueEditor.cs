...
namespace uComponents.Core.DataTypes.ToggleBox
{
	...
	public class TB_PrevalueEditor : AbstractJsonPrevalueEditor
	{
		...
		public TB_PrevalueEditor(BaseDataType dataType)
		...
		protected override void OnInit(EventArgs e)
		{
			...
			this.AddResourceToClientDependency(uComponents.Core.DataTypes.TextImage.TextImageExtensions.ColorpickerJs, ClientDependency.Core.ClientDependencyType.Javascript);
		}
