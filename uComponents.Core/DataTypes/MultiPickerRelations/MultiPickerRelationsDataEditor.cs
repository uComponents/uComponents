...
namespace uComponents.Core.DataTypes.MultiPickerRelations
{
    ...
    /// </summary>
    public class MultiPickerRelationsDataEditor : CompositeControl, IDataEditor
    {
        /// <summary>
        ...
        /// </summary>
        private MultiPickerRelationsOptions options;
        ...
        {
			this.statusLiteral.ID = "multiPickerRelations";
            this.Controls.Add(this.statusLiteral); // displays if this datatype is valid in this context, and if so, which multiNodePickerProperty and relationtype it wires up			
        ...
        private string GetMappingDetails()
        {
            ...
            Property multiNodePickerProperty = currentContentNode.getProperty(this.options.PropertyAlias);
            ...
            if (multiNodePickerProperty != null)
            {
                ...
                {
                    mappingDetails = "Property '<strong>" + multiNodePickerProperty.PropertyType.Name + "</strong>' with " + 
