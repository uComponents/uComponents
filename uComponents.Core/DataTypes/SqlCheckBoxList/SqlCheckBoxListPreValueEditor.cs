...
namespace uComponents.Core.DataTypes.SqlCheckBoxList
{
	...
	public class SqlCheckBoxListPreValueEditor : AbstractJsonPrevalueEditor
	{
		...
		/// </summary>
		internal SqlCheckBoxListOptions Options
		{
			get
			{
				if (this.options == null)
				{
					...
					this.options = this.GetPreValueOptions<SqlCheckBoxListOptions>();
		...
		public SqlCheckBoxListPreValueEditor(BaseDataType dataType)
